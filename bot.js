...
client.on('guildMemberAdd', member => {
  ...
  if (!channel) return;
  channel.send(`:confetti_ball:  Welcome to the server ${member}. You can drop your Tradingview profile name in ${msgchannel} to get access of ape[x] and don't forgot to read ${faqchannel}.`);
  console.log('Added');
});
